...
test.describe('State Persistence: Concurrent Hard Refresh', () => {
  ...
  test('10 players hard refresh simultaneously', async () => {
    ...
    // Step 4: All socket players join
    console.log('Step 4: Socket players joining game...');
    await Promise.all(socketPlayers.map(p => p.joinGame(gameId)));
    console.log('✅ 40 socket players joined\n');

    // Step 5: Browser players join
    console.log('Step 5: Browser players joining game...');
    await Promise.all(browserPlayers.map(p => p.navigateToGame(gameId)));
    console.log('✅ 10 browser players joined\n');

    // Step 6: Enable auto-mark for all socket players
    console.log('Step 6: Enabling auto-mark...');
    ...
    // Step 8: Call 25 numbers
    console.log('Step 8: Calling 25 numbers...');
    ...
    // Step 9: Record browser player state BEFORE refresh
    console.log('Step 9: Recording state before refresh...');
    ...
    // Step 10: All 10 browser players hard refresh SIMULTANEOUSLY
    console.log('Step 10: Hard refreshing 10 players simultaneously...');
    ...
    // Step 11: Verify state AFTER refresh
    console.log('Step 11: Validating state after refresh...');
    ...
    // Step 12: Verify socket players unaffected
    console.log('Step 12: Validating socket players unaffected...');
    ...
    // Step 13: Continue game - call 10 more numbers
    console.log('Step 13: Continuing game (calling 10 more numbers)...');
